...
// ── တွတ် (Tut) Generator: 5 Permutations + 2 Near-Misses (+1, -1) ─────────────
// Rules in Myanmar 3D lottery:
// 1. Winning Number: Exact 3-digit number (ဒဲ့)
// 2. Permutations (အပြန်): all other anagrams of the winning digits (up to 5, less if repeating digits like 212, 222)
...
function calculateTutNumbers(winningNumber) {
